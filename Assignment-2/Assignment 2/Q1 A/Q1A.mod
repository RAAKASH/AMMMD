...
var X{CITY} binary; # = 1 if an FC is opened at city f

var Y{CITY,CITY} binary; # = 1 if FC at city f is catering to city c
...
X_Y_link1 {f in CITY}: sum{c in CITY}Y[f,c] <= N*X[f];
